...
public class Mrn24GBDE3CF94H96TAR0ScenarioGenerator(IServiceProvider sp, ILogger<Mrn24GBDE3CF94H96TAR0ScenarioGenerator> logger) : SpecificFilesScenarioGenerator(sp, logger)
{
...
public class Mrn24GBDE3CF94H96TAR0ModifiedScenarioGenerator(IServiceProvider sp, ILogger<Mrn24GBDE3CF94H96TAR0ScenarioGenerator> logger) : SpecificFilesScenarioGenerator(sp, logger)
{
    public override GeneratorResult Generate(int scenario, int item, DateTime entryDate, ScenarioConfig config)
    {
        ...
        var decisionV1Builder =
            (DecisionBuilder)builders.Single(b => b.filePath == "Mrn-24GBDE3CF94H96TAR0/DECISIONS/2024/12/03/24GBDE3CF94H96TAR0-0deb3808-c55e-4196-9270-50ff1ee2ce49.json").builder;
