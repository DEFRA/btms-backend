...
public class ChedADecisionFinderTests
{
    ...
    [InlineData(false, null, DecisionNotAcceptableActionEnum.Destruction, new[] { "Other" }, DecisionCode.X00,
        DecisionInternalFurtherDetail.E97)]
    [InlineData(false, null, DecisionNotAcceptableActionEnum.Transformation, new[] { "Other" }, DecisionCode.X00,
        DecisionInternalFurtherDetail.E97)]
    [InlineData(false, null, DecisionNotAcceptableActionEnum.Other, new[] { "Other" }, DecisionCode.X00,
        DecisionInternalFurtherDetail.E97)]
