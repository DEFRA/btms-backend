...
public static class ImportNotificationStatusEnumMapper
{
    public static Btms.Model.Ipaffs.ImportNotificationStatusEnum? Map(Btms.Types.Ipaffs.ImportNotificationStatusEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum ImportNotificationStatusEnum value Btms.Types.Ipaffs.ImportNotificationStatusEnum")
        };
    }
}
