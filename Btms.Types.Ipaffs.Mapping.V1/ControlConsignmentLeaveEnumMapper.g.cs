...
public static class ControlConsignmentLeaveEnumMapper
{
    public static Btms.Model.Ipaffs.ControlConsignmentLeaveEnum? Map(Btms.Types.Ipaffs.ControlConsignmentLeaveEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum ControlConsignmentLeaveEnum value Btms.Types.Ipaffs.ControlConsignmentLeaveEnum")
        };
    }
}
