...
public static class DecisionIfChanneledOptionEnumMapper
{
    public static Btms.Model.Ipaffs.DecisionIfChanneledOptionEnum? Map(Btms.Types.Ipaffs.DecisionIfChanneledOptionEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum DecisionIfChanneledOptionEnum value Btms.Types.Ipaffs.DecisionIfChanneledOptionEnum")
        };
    }
}
