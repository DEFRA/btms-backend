...
public static class LaboratoryTestsTestReasonEnumMapper
{
    public static Btms.Model.Ipaffs.LaboratoryTestsTestReasonEnum? Map(Btms.Types.Ipaffs.LaboratoryTestsTestReasonEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum LaboratoryTestsTestReasonEnum value Btms.Types.Ipaffs.LaboratoryTestsTestReasonEnum")
        };
    }
}
