...
public static class InspectionCheckStatusEnumMapper
{
    public static Btms.Model.Ipaffs.InspectionCheckStatusEnum? Map(Btms.Types.Ipaffs.InspectionCheckStatusEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum InspectionCheckStatusEnum value Btms.Types.Ipaffs.InspectionCheckStatusEnum")
        };
    }
}
