...
public static class DecisionNotAcceptableActionEnumMapper
{
    public static Btms.Model.Ipaffs.DecisionNotAcceptableActionEnum? Map(Btms.Types.Ipaffs.DecisionNotAcceptableActionEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum DecisionNotAcceptableActionEnum value Btms.Types.Ipaffs.DecisionNotAcceptableActionEnum")
        };
    }
}
