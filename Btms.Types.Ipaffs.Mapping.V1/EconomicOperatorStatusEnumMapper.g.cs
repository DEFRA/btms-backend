...
public static class EconomicOperatorStatusEnumMapper
{
    public static Btms.Model.Ipaffs.EconomicOperatorStatusEnum? Map(Btms.Types.Ipaffs.EconomicOperatorStatusEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum EconomicOperatorStatusEnum value Btms.Types.Ipaffs.EconomicOperatorStatusEnum")
        };
    }
}
