...
public static class ApplicantAnalysisTypeEnumMapper
{
    public static Btms.Model.Ipaffs.ApplicantAnalysisTypeEnum? Map(Btms.Types.Ipaffs.ApplicantAnalysisTypeEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum ApplicantAnalysisTypeEnum value Btms.Types.Ipaffs.ApplicantAnalysisTypeEnum")
        };
    }
}
