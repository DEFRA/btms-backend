...
public static class PartThreeControlStatusEnumMapper
{
    public static Btms.Model.Ipaffs.PartThreeControlStatusEnum? Map(Btms.Types.Ipaffs.PartThreeControlStatusEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum PartThreeControlStatusEnum value Btms.Types.Ipaffs.PartThreeControlStatusEnum")
        };
    }
}
