...
public static class PurposeInternalMarketPurposeEnumMapper
{
    public static Btms.Model.Ipaffs.PurposeInternalMarketPurposeEnum? Map(Btms.Types.Ipaffs.PurposeInternalMarketPurposeEnum? from)
    {
        ...
        return from switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(from), from, "Unable to map enum PurposeInternalMarketPurposeEnum value Btms.Types.Ipaffs.PurposeInternalMarketPurposeEnum")
        };
    }
}
