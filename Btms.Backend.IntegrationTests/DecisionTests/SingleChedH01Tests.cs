...
public class SingleChedH01Tests(
    InMemoryScenarioApplicationFactory<SimpleMatchScenarioGenerator> factory,
    ITestOutputHelper testOutputHelper)
    : BaseApiTests(factory, testOutputHelper, "DecisionTests"),
        IClassFixture<InMemoryScenarioApplicationFactory<SimpleMatchScenarioGenerator>>
{
    [Fact]
