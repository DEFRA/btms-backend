...
public class DecisionCodeTests(ITestOutputHelper output) : MultipleScenarioGeneratorBaseTest(output)
{
    ...
    [InlineData(typeof(ChedDh01ScenarioGenerator1), "H01", "H01", "H01")]
    [InlineData(typeof(ChedDh01ScenarioGenerator2), "H01", "H01", "H01")]
    [InlineData(typeof(ChedDh01ScenarioGenerator3), "H01", "H01", "H01")]
    [InlineData(typeof(ChedDh01ScenarioGenerator4), "H01", "H01", "H01")]
    ...
    [InlineData(typeof(ChedDh02ScenarioGenerator1), "H02", "H02", "H02")]
    [InlineData(typeof(ChedDh02ScenarioGenerator2), "H02", "H02", "H02")]
    ...
    [InlineData(typeof(ChedDc03ScenarioGenerator), "C03", "C03", "C03")]
    ...
    [InlineData(typeof(ChedDn02ScenarioGenerator), "N02", "N02", "N02")]
    [InlineData(typeof(ChedDn04ScenarioGenerator), "N04", "N04", "N04")]
    ...
    [InlineData(typeof(IuuScenarioGenerator), "C03", "C07")]
    
    [InlineData(typeof(Mrn24Gbdzsrxdxtbvkar6ScenarioGenerator), "H02", "H02", "C03")]
