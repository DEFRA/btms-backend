    ...
    : BaseApiTests(factory, testOutputHelper, "DecisionTests"), IClassFixture<TestDataGeneratorFactory>
{
    ...
    public async Task MultipleNotificationVersionScenario_ShouldBeLinkedAndMatchDecision()
    {
        ...
        var chedPMovement = (AlvsClearanceRequest)loadedData.Single(d =>
                d is { generator: ChedPMultiStepScenarioGenerator, message: AlvsClearanceRequest })
            .message;
        ...
        var chedPNotification = (Types.Ipaffs.ImportNotification)loadedData.FirstOrDefault(d =>
                d is { generator: ChedPMultiStepScenarioGenerator, message: Types.Ipaffs.ImportNotification })
            .message;
