...
aws --endpoint-url=$ENDPOINT_URL sns subscribe --topic-arn arn:aws:sns:eu-west-2:000000000000:customs_clearance_request.fifo --protocol sqs --notification-endpoint arn:aws:sqs:eu-west-2:000000000000:customs_clearance_request.fifo
aws --endpoint-url=$ENDPOINT_URL sns subscribe --topic-arn arn:aws:sns:eu-west-2:000000000000:customs_finalisation_notification.fifo --protocol sqs --notification-endpoint arn:aws:sqs:eu-west-2:000000000000:customs_finalisation_notification.fifo
aws --endpoint-url=$ENDPOINT_URL sns subscribe --topic-arn arn:aws:sns:eu-west-2:000000000000:customs_error_notification.fifo --protocol sqs --notification-endpoint arn:aws:sqs:eu-west-2:000000000000:customs_error_notification.fifo
aws --endpoint-url=$ENDPOINT_URL sns subscribe --topic-arn arn:aws:sns:eu-west-2:000000000000:alvs_decision_notification.fifo --protocol sqs --notification-endpoint arn:aws:sqs:eu-west-2:000000000000:alvs_decision_notification.fifo
aws --endpoint-url=$ENDPOINT_URL sns subscribe --topic-arn arn:aws:sns:eu-west-2:000000000000:alvs_error_notification.fifo --protocol sqs --notification-endpoint arn:aws:sqs:eu-west-2:000000000000:alvs_error_notification.fifo
